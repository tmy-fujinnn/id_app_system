...
public class ApplicationForm {
    ...
    private static String findInvalidNameField(String[][] pairs) {
        for (String[] pair : pairs) {
            String val = pair[1];
            if (!val.isEmpty() && !isValidName(val))
                return pair[0];
        }
        return null;
    }
    ...
    public static void open(JFrame parentFrame) {
        ...
        submitBtn.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                submitBtn.setBackground(Constants.C_PRIMARY_DARK);
            }
        ...
        Runnable doSubmit = () -> {
            ...
            try (Connection conn = DBUtil.getConnection()) {
                ...
                String parentSql = "INSERT INTO parent_t (parent_id,applicant_id,parent_type,is_unknown," +
                ...
                try (PreparedStatement ps = conn.prepareStatement(parentSql)) {
                    ...
                    ps.setString(4, fatherUnk ? "YES" : "NO");
                ...
                try (PreparedStatement ps = conn.prepareStatement(parentSql)) {
                    ps.setString(1, motherId);
                    ps.setString(2, applicantId);
                    ps.setString(3, "Mother");
                    ps.setString(4, motherUnk ? "YES" : "NO");
